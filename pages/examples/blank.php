  ...
  <?php
    ...
    if(!isset($_SESSION['userName'])){
      ...
      if (!empty($_GET['id'])) {
        ...
        $book=$connection->selectRow( "*" ,$condition);
        //var_dump($book); exit();
        if (empty($book)) {
        ...
        <section class="content">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">TiTle : <?php echo $book['title']; ?></h3>
            ...
            <div class="box-body">
              INTRO : <?php echo $book['intro']; ?>
              <br/>
              <br/>
              <img  height="250" width="250" src="../../uploads/<?php echo $book['cover'];?>">
            </div><!-- /.box-body -->
            <div class="box-footer">
             Author : <?php echo $book['auther']; ?>
            </div><!-- /.box-footer-->
          </div><!-- /.box -->
